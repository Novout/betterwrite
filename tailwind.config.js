...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      'theme-background-aside': 'var(--theme-background-aside)',
      'theme-background-aside-lines': 'var(--theme-background-aside-lines)',
      'theme-background-aside-active': 'var(--theme-background-aside-active)',
      'theme-background-aside-item': 'var(--theme-background-aside-item)',
      'theme-background-aside-item-active': 'var(--theme-background-aside-item-active)',
