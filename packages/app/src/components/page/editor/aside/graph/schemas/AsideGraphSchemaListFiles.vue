<template>
  ...
  >
    <div class="w-full">
      ...
      >
        <InputColorPicker
          v-if="element.extra?.color"
          v-model="element.extra.color"
          class="w-2 h-2"
        />
        <div
        ...
        <div class="flex items-center">
          ...
          <IconArrowRight
            ...
            @click.prevent.stop="
              element.extra.configuration = !element.extra.configuration
            "
          />
        </div>
      </div>
      <div v-if="element.extra.id" class="flex flex-col gap-2 wb-text w-full">
        <div
          v-if="element.extra.configuration"
          class="flex flex-col w-full gap-2 mt-5"
        >
...
<script setup lang="ts">
  ...
  watch(
    computed(() => props.folder.customIcon),
    (icon) => {
      if (icon)
