<template>
  ...
  >
    ...
    <AuthIntegrationsButton v-if="env.isDev()" provider="google" color="#EEE">
      <svg
    ...
    <AuthIntegrationsButton provider="gitlab" color="#FF7646">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        aria-hidden="true"
    ...
    <AuthIntegrationsButton provider="github" color="#111111">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        aria-hidden="true"
