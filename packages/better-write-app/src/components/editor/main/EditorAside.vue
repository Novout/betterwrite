<template>
  <aside
    ...
    ref="aside"
    v-motion="'aside'"
    class="fixed wb-edit md:relative overflow-y-auto w-full md:w-60 lg:w-72 xl:w-80 bg-theme-aside-background hover:bg-theme-aside-background-hover active:bg-theme-aside-background-active z-20 shadow-lg"
    :style="{ left, opacity }"
    :initial="{
      x: -240,
    }"
