...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      'theme-editor-creative-drafts-container-background': 'var(--theme-editor-creative-drafts-container-background)',
      'theme-editor-creative-drafts-container-borders': 'var(--theme-editor-creative-drafts-container-borders)',
      'theme-editor-creative-drafts-container-list-background': 'var(--theme-editor-creative-drafts-container-list-background)',
      'theme-editor-creative-drafts-container-list-background-hover': 'var(--theme-editor-creative-drafts-container-list-background-hover)',
      'theme-editor-creative-drafts-container-list-background-active': 'var(--theme-editor-creative-drafts-container-list-background-active)',
      'theme-editor-creative-drafts-container-list-text': 'var(--theme-editor-creative-drafts-container-list-text)',
      'theme-editor-creative-drafts-container-list-text-hover': 'var(--theme-editor-creative-drafts-container-list-text-hover)',
      'theme-editor-creative-drafts-container-list-text-active': 'var(--theme-editor-creative-drafts-container-list-text-active)',
      'theme-editor-creative-drafts-container-item-background': 'var(--theme-editor-creative-drafts-container-item-background)',
      'theme-editor-creative-drafts-container-item-background-hover': 'var(--theme-editor-creative-drafts-container-item-background-hover)',
      'theme-editor-creative-drafts-container-item-background-active': 'var(--theme-editor-creative-drafts-container-item-background-active)',
      'theme-editor-creative-drafts-container-item-text': 'var(--theme-editor-creative-drafts-container-item-text)',
