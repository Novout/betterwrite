...
export const setTailwindCssVariables = () => {
	return {
		...
		'theme-editor-full-background-hover': 'var(--theme-editor-full-background-hover)',
		'theme-editor-full-background-active': 'var(--theme-editor-full-background-active)',
		...
		'theme-editor-entity-warning-hover': 'var(--theme-editor-entity-warning-hover)',
		'theme-editor-entity-warning-active': 'var(--theme-editor-entity-warning-active)',
		...
		'theme-editor-entity-error-active': 'var(--theme-editor-entity-error-active)',
		...
		'theme-editor-creative-drafts-background': 'var(--theme-editor-creative-drafts-background)',
